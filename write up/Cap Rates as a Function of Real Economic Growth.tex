...
Studies that focus on macroeconomic variables often include both GDP (or its derivative) and Inflation (or its derivative. The results are often that one variable is significant while the other is not. 
