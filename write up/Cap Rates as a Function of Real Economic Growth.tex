...
\subsection*{Purpose}
To explain and forecast both national and market-level cap rate moves as a function of Gross Domestic Product and Consumer Price Index.

\subsection*{Design/Methodology/Approach}
We use a binary logistic regression with binary independent variables (GDP expansion > CPI expansion. GDP expansion and relative CPI expansion) to explain cap rate expansion and contraction.
