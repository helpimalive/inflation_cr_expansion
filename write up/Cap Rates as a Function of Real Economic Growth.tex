...
We first sought to test the strength of the relationship using a binary logistic regression model over all time periods of data. Next, we wanted to establish the validity of the model for predictive power so we trained five separate iterations (Year = 2015, 2016....2020) which were given historical data and then asked to predict the next years' (Years 2016-2021, 2017-2021,...2021) cap rate expansions and contractions based on the CPI and GDP values. 
