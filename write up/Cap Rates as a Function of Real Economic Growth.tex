...
\csvautotabular{C:/Users/matth/Documents/GitHub/inflation_cr_expansion/output/msa_level_fit.csv}\caption{Relevant parameters and metrics from the logistic regression trained jointly on all MSA data, both in and out of sample}
\end{table}
...
\csvautotabular{C:/Users/matth/Documents/GitHub/inflation_cr_expansion/output/ols_summary_all_msa.csv}
\caption{The results of an ordinary least squares regression on the relationship between household growth and the outperformance of the cap rate model versus a buy-and-hold strategy. The graph illustrates that in MSAs (each dot) where household growth has been low, the strategy has outperformed}
\end{table}
...
\centering
\caption*{Regression Output: Model Outperformance as a function of HH Growth}
\csvautotabular{C:/Users/matth/Documents/GitHub/inflation_cr_expansion/output/ols_summary_all_msa_no_leverage.csv}
\caption{The results of an ordinary least squares regression on the relationship between household growth and the outperformance of the cap rate model versus a buy-and-hold strategy. The graph illustrates that in MSAs (each dot) where household growth has been low, the strategy has outperformed}
\end{table}
